...
SECRET_KEY = 'django-insecure-mlam0-r=c#$r8^(ca2$v2ka)*kdj@tmx*knfay_mj40*p8i782'
...
# Optional, only if you have custom static files
STATICFILES_DIRS = [
    BASE_DIR / "static",   # comment this out if the folder doesn’t exist
]
